...
def strengths_energy_unique(topic_entities_dict, nr_critics):
	print("sono in strengths ENERGY NO PREF")
	nr_votes = dict()
	...
	for key in topic_entities_dict.keys():
		...
		if key == "writer" or key == "director":
			...
			feature_strengths[key] = quadratic_energy_strength(base_score_act, atts,supps)
			...
			feature_strengths[key] = quadratic_energy_strength(base_score_theme, atts,supps)
