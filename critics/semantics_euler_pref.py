...
def strengths_euler_weights_extended(topic_entities_dict, nr_critics, listAnsPref, list_keys, list_entities_preferences, list_entities_complete):
	nr_votes = dict()
	levelsLists=[]
	print("Sono in EULER WEIGHTS")
...
def strengths_euler_attacks_extended(topic_entities_dict, nr_critics, listAnsPref, list_keys, list_entities_preferences, list_entities_complete):
	print("Sono in EULER ATTACKS, nr critics %d" % nr_critics)
